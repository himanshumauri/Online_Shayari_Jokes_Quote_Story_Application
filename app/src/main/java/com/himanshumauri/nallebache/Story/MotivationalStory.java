...
public class MotivationalStory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("story").child("motivationalstory");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent intent = new Intent(MotivationalStory.this, ReadStory.class);
