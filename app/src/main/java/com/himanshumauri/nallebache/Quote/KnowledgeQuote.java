...
public class KnowledgeQuote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("quotes").child("knowledgequotes").child("quote");
